...
<?php echo html::stylesheet( 'plugins/analytics-plugin/media/css/d3.parcoords.css', 'screen', FALSE ); ?>
<?php echo html::stylesheet( 'plugins/analytics-plugin/media/css/analytics', 'screen', FALSE ); ?>
<div id="content">
